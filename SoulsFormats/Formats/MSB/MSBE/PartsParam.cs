    ...
    public partial class MSBE
    {
                ...
                switch (part)
                {
                    ...
                    default:
                        throw new ArgumentException(
                            $"Unrecognized type {part.GetType()}.",
                            nameof(part)
                        );
                }
                return part;
        ...
        public abstract class Part : Entry, IMsbPart
        {
            ...
            private protected Part(BinaryReaderEx br)
            {
                ...
                if (nameOffset == 0)
                    throw new InvalidDataException(
                        $"{nameof(nameOffset)} must not be 0 in type {GetType()}."
                    );
                if (sibOffset == 0)
                    throw new InvalidDataException(
                        $"{nameof(sibOffset)} must not be 0 in type {GetType()}."
                    );
                if (HasUnk1 ^ unkOffset1 != 0)
                    throw new InvalidDataException(
                        $"Unexpected {nameof(unkOffset1)} 0x{unkOffset1:X} in type {GetType()}."
                    );
                if (HasUnk2 ^ unkOffset2 != 0)
                    throw new InvalidDataException(
                        $"Unexpected {nameof(unkOffset2)} 0x{unkOffset2:X} in type {GetType()}."
                    );
                if (entityDataOffset == 0)
                    throw new InvalidDataException(
                        $"{nameof(entityDataOffset)} must not be 0 in type {GetType()}."
                    );
                if (typeDataOffset == 0)
                    throw new InvalidDataException(
                        $"{nameof(typeDataOffset)} must not be 0 in type {GetType()}."
                    );
                if (HasGparamConfig ^ gparamOffset != 0)
                    throw new InvalidDataException(
                        $"Unexpected {nameof(gparamOffset)} 0x{gparamOffset:X} in type {GetType()}."
                    );
                if (HasSceneGparamConfig ^ sceneGParamOffset != 0)
                    throw new InvalidDataException(
                        $"Unexpected {nameof(sceneGParamOffset)} 0x{sceneGParamOffset:X} in type {GetType()}."
                    );
                if (HasUnk7 ^ unkOffset7 != 0)
                    throw new InvalidDataException(
                        $"Unexpected {nameof(unkOffset7)} 0x{unkOffset7:X} in type {GetType()}."
                    );
                if (HasUnk8 ^ unkOffset8 != 0)
                    throw new InvalidDataException(
                        $"Unexpected {nameof(unkOffset8)} 0x{unkOffset8:X} in type {GetType()}."
                    );
                if (HasUnk9 ^ unkOffset9 != 0)
                    throw new InvalidDataException(
                        $"Unexpected {nameof(unkOffset9)} 0x{unkOffset9:X} in type {GetType()}."
                    );
                if (HasUnk10 ^ unkOffset10 != 0)
                    throw new InvalidDataException(
                        $"Unexpected {nameof(unkOffset10)} 0x{unkOffset10:X} in type {GetType()}."
                    );
                if (HasUnk11 ^ unkOffset11 != 0)
                    throw new InvalidDataException(
                        $"Unexpected {nameof(unkOffset11)} 0x{unkOffset11:X} in type {GetType()}."
                    );
            ...
            public class MapPiece : Part
            {
                ...
                private protected override void ReadUnk1(BinaryReaderEx br) =>
                    Unk1 = new UnkStruct1(br);

                private protected override void ReadGparamConfig(BinaryReaderEx br) =>
                    Gparam = new GparamConfig(br);

                private protected override void ReadUnk7(BinaryReaderEx br) =>
                    Unk7 = new UnkStruct7(br);

                private protected override void ReadUnk8(BinaryReaderEx br) =>
                    Unk8 = new UnkStruct8(br);

                private protected override void ReadUnk9(BinaryReaderEx br) =>
                    Unk9 = new UnkStruct9(br);

                private protected override void ReadUnk10(BinaryReaderEx br) =>
                    Unk10 = new UnkStruct10(br);

                private protected override void ReadUnk11(BinaryReaderEx br) =>
                    Unk11 = new UnkStruct11(br);
                ...
                private protected override void WriteGparamConfig(BinaryWriterEx bw) =>
                    Gparam.Write(bw);
            ...
            public abstract class EnemyBase : Part
            {
                ...
                private protected EnemyBase(BinaryReaderEx br)
                    : base(br) { }
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
                ...
                private protected override void ReadUnk2(BinaryReaderEx br) =>
                    Unk2 = new UnkStruct2(br);

                private protected override void ReadGparamConfig(BinaryReaderEx br) =>
                    Gparam = new GparamConfig(br);

                private protected override void ReadSceneGparamConfig(BinaryReaderEx br) =>
                    SceneGparam = new SceneGparamConfig(br);
                ...
                private protected override void WriteSceneGparamConfig(BinaryWriterEx bw) =>
            ...
            public class DummyAsset : Part
            {
                ...
                internal DummyAsset(BinaryReaderEx br)
                    : base(br) { }
            ...
            public class Asset : Part
            {
                ...
                public class AssetUnkStruct3
                {
                    ...
                    public AssetUnkStruct3 DeepCopy()
                    {
                        ...
                        unks3.DisableWhenMapLoadedMapID = (sbyte[])
                            DisableWhenMapLoadedMapID.Clone();
                        return unks3;
                    }
