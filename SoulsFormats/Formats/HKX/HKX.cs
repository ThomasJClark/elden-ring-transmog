...
#pragma warning disable CS1591
        ...
        public class HKXSection
        {
            ...
            {
                BinaryReaderEx br = new BinaryReaderEx(
                    (hkx.Header.Endian == 0) ? true : false,
                    SectionData
                );
                ...
                for (int i = 0; i < VirtualFixups.Count; i++)
                {
                    ...
                    reference.ClassName = ((HKXClassNames)hkx.ClassSection.Objects[0]).Lookup(
                        VirtualFixups[i].NameOffset
                    );

                    br.Position = VirtualFixups[i].Src;
                    var length =
                        (i + 1 < VirtualFixups.Count)
                            ? VirtualFixups[i + 1].Src - VirtualFixups[i].Src
                            : LocalFixupsOffset - VirtualFixups[i].Src;
                    HKXObject hkobject;
                    if (deserializeObjects)
                    {
                        ...
                        else if (reference.ClassName.ClassName == "hkaiNavMesh")
                        {
                            ...
                            reference.ClassName.ClassName == "hkcdStaticTreeDefaultTreeStorage6"
                        )
                        {
                        ...
                        else if (reference.ClassName.ClassName == "hkaAnimationBinding")
                        {
                            ...
                            reference.ClassName.ClassName == "hkaDefaultAnimatedReferenceFrame"
                        )
                        {
        ...
        public class HKXLocalReference
        {
            ...
            {
                SourceLocalOffset =
                    (uint)bw.Position - SourceObject.SectionOffset - sectionBaseOffset;
        ...
        public abstract class HKXObject
        {
            ...
            protected List<GlobalFixup> FindGlobalFixupDestinations(HKX hkx, HKXSection section)
            {
                ...
                {
                    if (
                        (gu.DstSectionIndex == section.SectionID)
                        && gu.Dst >= SectionOffset
                        && gu.Dst < (SectionOffset + DataSize)
                    )
                    {
                        sources.Add(gu);
                    }
            ...
            internal HKXLocalReference ResolveLocalReference(
                HKX hkx,
                HKXSection section,
                BinaryReaderEx br
            )
            {
                ...
                return ResolveLocalReference(
                    section,
                    (uint)br.Position - SectionOffset - hkx.Header.PointerSize
                );
            }
            ...
            internal HKXGlobalReference ResolveGlobalReference(
                HKX hkx,
                HKXSection section,
                BinaryReaderEx br
            )
        ...
        public abstract class IHKXSerializable
        {
            ...
            internal virtual void WriteReferenceData(
                HKX hkx,
                HKXSection section,
                BinaryWriterEx bw,
                uint sectionBaseOffset,
        ...
        public class HKArrayData<T> : HKXObject
        ...
        public class HKArray<T> : IHKXSerializable
            where T : IHKXSerializable, new()
        {
            ...
            internal override void WriteReferenceData(
                HKX hkx,
                HKXSection section,
                BinaryWriterEx bw,
                uint sectionBaseOffset,
        ...
        public class HKCString : IHKXSerializable
        {
            ...
            )
            {
                if (Data != null)
                {
                    ((HKCStringData)Data.DestObject).Write(
                        hkx,
                        section,
                        bw,
                        sectionBaseOffset,
        ...
        public class HKXGenericObject : HKXObject
        {
            ...
            public void WriteWithReferences(
                HKX hkx,
                HKXSection section,
                BinaryWriterEx bw,
                uint sectionBaseOffset,
