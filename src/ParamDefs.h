...
extern "C"
{
    ...
    typedef struct _CUTSCENE_WEATHER_OVERRIDE_GPARAM_ID_CONVERT_PARAM_ST
    ...
    struct _GAME_SYSTEM_COMMON_PARAM_ST
    {
        ...
        dummy8 reserved_124_0[48];
        dummy8 reserved_124_1[32];
        f32 unkR00;
        f32 unkR04;
        f32 unkR08;
        f32 unkR12;
    ...
    typedef struct _LOAD_BALANCER_NEW_DRAW_DIST_SCALE_PARAM_ST
    ...
    typedef struct _MAP_GRID_CREATE_HEIGHT_LIMIT_INFO_PARAM_ST
    ...
    typedef struct _SOUND_ASSET_SOUND_OBJ_ENABLE_DIST_PARAM_ST
    ...
    typedef struct _SOUND_AUTO_REVERB_EVALUATION_DIST_PARAM_ST
    ...
    typedef CUTSCENE_WEATHER_OVERRIDE_GPARAM_ID_CONVERT_PARAM_ST
